...
const Sorteos = () => {
    ...
    <Layout>
      <Section>
        <Container>
          ...
          <AlignedDiv>
            <DescriptionText>
              Próximamente se anunciarán los sorteos y premios de las Jornadas
            </DescriptionText>
          </AlignedDiv>
  ...
  que puedas!</DescriptionText>
          <DescriptionText>
            <Highlight>Lugar: </Highlight>Entrega del premio
      en el puesto
  central.</DescriptionText>
          <DescriptionText>
            <Highlight>Días: </Highlight>6 y 7 de Febrero.<
      /DescriptionText>
          <DescriptionText>
            <Highlight>Hora de cierre de logros: </Highlight>18:
          00 < /DescriptionText>
          <br / > <AlignedDiv><TableSorteoLogros />
      </AlignedDiv>
          <AlignedDiv>
            <Hexagons>
              <HexagonB>⬢</HexagonB>
      <HexagonO>⬢</HexagonO>
              <HexagonY>⬢</HexagonY></Hexagons>
          </AlignedDiv>

      <Category>Festival de fortuna</Category>
          <SubCategory>Sorteo diario</SubCategory><br />
      <DescriptionText>En esta actividad,
      tendrás la oportunidad de participar en un sorteo
  visitando nuestros stands en el evento.Al llegar a cada stand,
      recibirás una papeleta que deberás sellar y depositar en una urna.Al final del evento,
  ...
  lado!</DescriptionText>
          <DescriptionText>
            <Highlight>Lugar: </Highlight>Entrega del premio en el
      puesto
  central.</DescriptionText>
          <DescriptionText>
            <Highlight>Días: </Highlight>6 y 7 de Febrero
      ...
      /DescriptionText>
          ...
          <br / > <AlignedDiv><TableSorteoStands /></AlignedDiv>
          <br />
      <DescriptionText><Highlight>Aviso:
          </Highlight>Solo se puede ganar un premio por
            persona y por día.
          </DescriptionText>
      <AlignedDiv><Hexagons><HexagonB>⬢</HexagonB>
              <HexagonO>⬢</HexagonO>
      <HexagonY>⬢</HexagonY>
            </Hexagons>
      </AlignedDiv>

          <Category>Sorteos por Redes Sociales</Category><br />
      <DescriptionText>Esta actividad te brinda la oportunidad de ganar premios
  emocionantes simplemente interactuando con nuestras redes sociales.Puedes participar siguiéndonos en nuestras redes
      sociales,
  ...
  ganar.</DescriptionText>
          <DescriptionText>
            <Highlight>Lugar: </Highlight>Entrega del premio en
          puesto central
              .</DescriptionText>
          <DescriptionText>
          ...
          <DescriptionText>
            <Highlight>Hora: </Highlight>18: 30 <
      /DescriptionText>
          <br / > <AlignedDiv><TableSorteoRedesSociales />
      </AlignedDiv>
          <AlignedDiv>
            <Hexagons>
              <HexagonB>⬢</HexagonB>
      ...
      <Category>Arcadia Bay</Category>
          <SubCategory> Competición Arcade</SubCategory><br />
      <DescriptionText>Revive la nostalgia de los videojuegos clásicos en nuestra
  ...
  ser el campeón ?
          ...
          <DescriptionText>
            <Highlight>Lugar: </Highlight>Delegación de Ingeniería
          Informática
              .</DescriptionText>
          <DescriptionText>
            <Highlight>Días: </Highlight>6 y 7 de Febrero
              .</DescriptionText>
          <DescriptionText>
            <Highlight>Horario: </Highlight>10 :
      00 - 18: 00. < /DescriptionText>

          <br / > <AlignedDiv><TableCompeticionArcade />
          </AlignedDiv>
          <AlignedDiv>
            <Hexagons>
              <HexagonB>⬢</HexagonB>
          ...
          <SubCategory>Trivial</SubCategory><br />

          <ul><DescriptionListElement>
              ¿Cuánto sabes realmente ?
      Participa en nuestros emocionantes
  trivials y pon a prueba tus conocimientos.Compite respondiendo
  desafiantes preguntas de diversas temáticas, demuestra tu
  sabiduría y podrás ganar grandes premios.</DescriptionListElement>
          </ul>

      <DescriptionText><Highlight>Lugar: </Highlight>Puesto central.
      ...
      <Category>Cazadores del conocimiento</Category>
          <SubCategory>Búsqueda del Tesoro</SubCategory><br />
      <DescriptionText>Embárcate en una emocionante aventura explorando todos los rincones
  ...
  mantener el misterio
      ...
      <DescriptionLink href = 'https://forms.gle/9Cn1wbEz71gFRLa78'>
              ¡Click Aquí!</DescriptionLink>
          </DescriptionText><br /><AlignedDiv><TableBusquedaTesoro />
      </AlignedDiv>
          <AlignedDiv>
            <Hexagons>
              <HexagonB>⬢</HexagonB>
      ...
      <Category>Misión andrómeda</Category>
          <SubCategory>Escape Room</SubCategory><br />
      <DescriptionText>Adéntrate en un emocionante Escape Room ambientado en una misión de
  ...
  competirán por el mejor tiempo de escape
      .</DescriptionText>
          <DescriptionText>
            <Highlight>Lugar: </Highlight>Puesto
          central</DescriptionText>
          <DescriptionText>
            <Highlight>Días: </Highlight>6 y 7 de
              Febrero.</DescriptionText>
          <DescriptionText>
            <Highlight>Horario: </Highlight>10: 00,
      12: 30, 15: 30,
      17: 30. < /DescriptionText>
      ...
      <DescriptionLink href = 'https://forms.gle/SKrDKKMdXBV7EVdw6'>
          ...
          <Category>Stand -
          out</Category>
          <SubCategory>Concurso del Mejor Stand</SubCategory><br />
          <DescriptionText>Reconoce la creatividad y la innovación votando por tu stand
  ...
  premios increíbles.</DescriptionText>
          <DescriptionText>
            <Highlight>Lugar: </Highlight>Entrega de
      premio y rifas en el puesto
  central.</DescriptionText>
          <DescriptionText>
            <Highlight>Días: </Highlight>6 y 7 de Febrero.<
      /DescriptionText>
          <DescriptionText>
            <Highlight>Hora de entrega del premio: </Highlight>18:
          00 <
      br / >
      ...
      <DescriptionText><Highlight>Martes 6: < /Highlight>
            <DescriptionLink href="https:/ / forms.gle /
          Qx5HXTPDfrXyHoWs6 ''
              ¡Click Aquí!</DescriptionLink>
          </DescriptionText>

          <DescriptionText><Highlight>Miércoles 7: <
      /Highlight>
            <DescriptionLink href="https:/ / forms.gle /
          nYCCsYpzErFHYxuPA ''
              ¡Click Aquí!</DescriptionLink>
          ...
          <br />
          <DescriptionText>Demuestra tus habilidades en los torneos de League of Legends(LoL)
  ...
  cantidad de participantes
      ...
      <DescriptionLink href = 'https://forms.gle/6z6LcAoRiJCsaxuSA'>
              ¡Click Aquí!</DescriptionLink>
          </DescriptionText><br /><AlignedDiv><TableVideojuegos />
      </AlignedDiv>
          <AlignedDiv>
            <Hexagons>
              <HexagonB>⬢</HexagonB>
      ...
      <Category>Maratón de mentes</Category>
          <SubCategory>Hackatón</SubCategory><br />
      <DescriptionText>Demuestra tus habilidades resolviendo problemas del mundo real.Forma equipos de 4 personas y
          compite para resolver la mayor
  ...
  suerte!</DescriptionText>
          <DescriptionText>
            <Highlight>Lugar: </Highlight>Por determinar
          .</DescriptionText>
          <DescriptionText>
            <Highlight>Día de presentación del reto: </Highlight>6 de
              Febrero.</DescriptionText>
          <DescriptionText>
            <Highlight>Hora: </Highlight>14: 00. <
      /DescriptionText>
          <DescriptionText>
            <Highlight>Día de mentorización: </Highlight >
      7 de Febrero.</DescriptionText>
          <DescriptionText>
            <Highlight>Horario: </Highlight>10: 00 -
          11: 00 y 15: 30 - 16: 30. <
      /DescriptionText>
          <DescriptionText>
            <Highlight>Día de entrega del premio: </Highlight >
      8 de Febrero
          .</DescriptionText>
          <DescriptionText>
      ...
      <Category>Dumbs and dice</Category>
          <SubCategory>Sesión de Rol</SubCategory><br />
      <DescriptionText>Prepárate para una tarde llena de imaginación y estrategia.En
  colaboración con Sabadospararoleros, te invitamos a participar en
  emocionantes partidas de rol,
      desde Dungeons&Dragons 5e hasta Call of Cthulhu.Sumérgete en mundos fantásticos y vive aventuras
